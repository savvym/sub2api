...
- Owner Private Default Group Binding 提交：`f532b2e5e`，完整 SHA `f532b2e5ecc0da16aa6d831d239f82a6633d1290`。每个 Owner/平台只复用或创建一个大小写不敏感名称为 `<platform>-default` 的 active/private/exclusive/legacy Group；首次创建同时检查 Account 与 Group 容量，已有默认组只检查 Account 容量。Account 固定 `schedulable=true` 并以优先级 50 绑定该 Group，Group/Account、两类 Scheduler Outbox 和 durable event 任一失败整体回滚。[push CI Run 33667177588](https://github.com/savvym/sub2api/actions/runs/33667177588) / [test job 100371684868](https://github.com/savvym/sub2api/actions/runs/33667177588/job/100371684868) 与 [PR CI Run 33667182608](https://github.com/savvym/sub2api/actions/runs/33667182608) / [test job 100371700879](https://github.com/savvym/sub2api/actions/runs/33667182608/job/100371700879) 均通过；无过滤 integration 分别为 3m12s 和 3m37s，repository 非缓存运行 39.640s 和 53.406s。对应 [push Security Scan 33667177598](https://github.com/savvym/sub2api/actions/runs/33667177598) 与 [PR Security Scan 33667182624](https://github.com/savvym/sub2api/actions/runs/33667182624) 也成功。
