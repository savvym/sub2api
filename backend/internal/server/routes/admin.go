...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/:id/account-candidates", h.Admin.Group.ListAccountCandidates)
		groups.POST("/:id/accounts", h.Admin.Account.CreateInGroup)
		groups.PATCH("/:id/accounts", h.Admin.Group.UpdateAccounts)
