...
const flagSelfServiceAccounts = makeSidebarFlag(FeatureFlags.selfServiceAccounts)
const flagSelfServiceGroups = makeSidebarFlag(FeatureFlags.selfServiceGroups)
