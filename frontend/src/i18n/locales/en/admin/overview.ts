export default {
    ...
    groups: {
      ...
      accountManagement: {
        ...
        pendingAdd: '{count} to add',
        pendingRemove: '{count} to remove',
        pendingAddBadge: 'To add',
        pendingRemoveBadge: 'To remove',
        searchPlaceholder: 'Search name or account ID',
        allTypes: 'All Types',
        allStatuses: 'All Statuses',
        selectCurrentPage: 'Select current page',
        addSelected: 'Add selected accounts',
        removeSelected: 'Remove selected accounts',
        addAccount: 'Add to current group',
        removeAccount: 'Remove from current group',
        undoAdd: 'Undo add',
        undoRemove: 'Undo removal',
        editAccount: 'Edit account',
        accountGroups: 'In {count} groups',
        saveChanges: 'Save Changes',
        saved: 'Group accounts updated',
        saveSummary: '{add} to add · {remove} to remove',
        loadFailed: 'Failed to load accounts',
        retry: 'Retry',
        emptyCandidatesFiltered: 'No accounts match the current filters',
        emptyCandidatesEligible: 'No accounts are eligible for this group',
        emptyMembersFiltered: 'No group accounts match the current filters',
        emptyMembers: 'This group has no accounts yet',
        discardTitle: 'Discard unsaved changes?',
        discardMessage: 'The pending account additions and removals will be lost when this dialog closes.',
        riskTitle: 'Confirm Mixed-channel Risk',
        riskMessage: 'Saving will leave this group with account channels that may conflict. Continue with this change?',
        riskConfirm: 'Confirm and Save',
        diffTooLarge: 'A single save can change at most 500 accounts. Reduce this batch and try again.',
        loadingEditor: 'Preparing the account editor...',
        editorLoadFailed: 'Unable to open the account editor',
        editGlobalImpact: 'Changes to this account apply to every group it belongs to.',
        types: {
          oauth: 'OAuth',
        ...
        policyWarnings: {
          platform_mismatch: 'Does not match the current platform policy',
          oauth_required: 'Does not meet the OAuth-only policy',
          oauth_only_required: 'Does not meet the OAuth-only policy',
          privacy_not_set: 'Does not meet the privacy policy',
          privacy_set_required: 'Does not meet the privacy policy',
          mixed_scheduling: 'Mixed scheduling risk',
          account_group_platform_mismatch: 'Does not match the current platform policy',
          account_group_policy_violation: 'Does not meet the current group policy'
        },
        errors: {
          invalid_account_membership_diff: 'The account changes are invalid. Reselect the accounts and try again.',
          account_membership_diff_too_large: 'A single save can change at most 500 accounts.',
          group_not_found: 'This group no longer exists.',
          account_not_found: 'Some accounts no longer exist. Reload and try again.',
          account_group_platform_mismatch: 'Some accounts are incompatible with this group platform.',
          account_group_policy_violation: 'Some accounts do not meet this group policy.',
          idempotency_conflict: 'The save request changed. Reload and try again.'
        }
      },
