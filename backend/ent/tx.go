...
func (tx *Tx) init() {
	...
	tx.AccountAccessGrant = NewAccountAccessGrantClient(tx.config)
	...
	tx.GroupAccessGrant = NewGroupAccessGrantClient(tx.config)
	...
	tx.ResourceAuthorizationEvent = NewResourceAuthorizationEventClient(tx.config)
