...
func TestAdminResetQuota_ResetBoth(t *testing.T) {
	...
	result, err := svc.ResetQuota(context.Background(), 1, true, true, false)
...
func TestAdminResetQuota_ResetDailyOnly(t *testing.T) {
	...
	result, err := svc.ResetQuota(context.Background(), 2, true, false, false)
...
func TestAdminResetQuota_ResetWeeklyOnly(t *testing.T) {
	...
	result, err := svc.ResetQuota(context.Background(), 3, false, true, false)
...
func TestAdminResetQuota_BothFalseReturnsError(t *testing.T) {
	...
	_, err := svc.ResetQuota(context.Background(), 7, false, false, false)
...
func TestAdminResetQuota_SubscriptionNotFound(t *testing.T) {
	...
	_, err := svc.ResetQuota(context.Background(), 999, true, true, true)
...
func TestAdminResetQuota_ResetDailyUsageError(t *testing.T) {
	...
	_, err := svc.ResetQuota(context.Background(), 4, true, true, false)
...
func TestAdminResetQuota_ResetWeeklyUsageError(t *testing.T) {
	...
	_, err := svc.ResetQuota(context.Background(), 5, false, true, false)
...
func TestAdminResetQuota_ResetMonthlyOnly(t *testing.T) {
	...
	result, err := svc.ResetQuota(context.Background(), 8, false, false, true)
...
func TestAdminResetQuota_BeforeStartsAtSameDayPreservesAutomaticBoundary(t *testing.T) {
	...
	result, err := svc.ResetQuota(context.Background(), 10, false, false, true)
...
func TestAdminResetQuota_ResetMonthlyUsageError(t *testing.T) {
	...
	_, err := svc.ResetQuota(context.Background(), 9, false, false, true)
...
func TestAdminResetQuota_ReturnsRefreshedSub(t *testing.T) {
	...
	svc := newResetQuotaSvc(stub)
	result, err := svc.ResetQuota(context.Background(), 6, true, false, false)
