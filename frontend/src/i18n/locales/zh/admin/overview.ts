export default {
    ...
    groups: {
      ...
      accountManagement: {
        ...
        available: '可添加',
        current: '当前分组',
        expectedCount: '预计 {count}',
        eligibleCount: '可添加 {count}',
        memberCount: '成员 {count}',
        filteredCount: '当前筛选 {count}',
        pendingAdd: '待加入 {count}',
        pendingRemove: '待移除 {count}',
        pendingAddBadge: '待加入',
        pendingRemoveBadge: '待移除',
        searchPlaceholder: '搜索名称或账号 ID',
        allTypes: '全部类型',
        allStatuses: '全部状态',
        selectCurrentPage: '全选当前页',
        addSelected: '加入所选账号',
        removeSelected: '移除所选账号',
        addAccount: '加入当前分组',
        removeAccount: '从当前分组移除',
        undoAdd: '撤销加入',
        undoRemove: '撤销移除',
        editAccount: '编辑账号',
        accountGroups: '已归属 {count} 个分组',
        saveChanges: '保存变更',
        saved: '分组账号已更新',
        saveSummary: '待加入 {add} 个 · 待移除 {remove} 个',
        loadFailed: '加载账号失败',
        retry: '重试',
        emptyCandidatesFiltered: '没有符合当前筛选的账号',
        emptyCandidatesEligible: '没有符合当前分组规则的账号',
        emptyMembersFiltered: '没有符合当前筛选的分组账号',
        emptyMembers: '当前分组还没有账号',
        discardTitle: '放弃未保存的变更？',
        discardMessage: '待加入和待移除的账号变更尚未保存，关闭后将全部丢失。',
        riskTitle: '确认混合渠道风险',
        riskMessage: '保存后当前分组将包含可能互相冲突的账号渠道。确认继续应用这批变更吗？',
        riskConfirm: '确认并保存',
        diffTooLarge: '单次最多变更 500 个账号，请减少本次操作数量',
        loadingEditor: '正在准备账号编辑器...',
        editorLoadFailed: '无法打开账号编辑器',
        editGlobalImpact: '修改此账号资料会影响该账号所在的所有分组。',
        types: {
          oauth: 'OAuth',
        ...
        policyWarnings: {
          platform_mismatch: '不符合当前平台策略',
          oauth_required: '不符合仅 OAuth 策略',
          oauth_only_required: '不符合仅 OAuth 策略',
          privacy_not_set: '不符合隐私保护策略',
          privacy_set_required: '不符合隐私保护策略',
          mixed_scheduling: '存在混合调度风险',
          account_group_platform_mismatch: '不符合当前平台策略',
          account_group_policy_violation: '不符合当前分组策略'
        },
        errors: {
          invalid_account_membership_diff: '账号变更无效，请重新选择后再试',
          account_membership_diff_too_large: '单次最多变更 500 个账号',
          group_not_found: '分组已不存在',
          account_not_found: '部分账号已不存在，请重新加载后再试',
          account_group_platform_mismatch: '部分账号与当前分组平台不兼容',
          account_group_policy_violation: '部分账号不符合当前分组策略',
          idempotency_conflict: '保存请求已发生变化，请重新加载后再试'
        }
      },
      form: {
        name: '名称',
