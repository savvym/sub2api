...
// SetPermissionID sets the "permission_id" field.
func (u *RolePermissionUpsert) SetPermissionID(v int64) *RolePermissionUpsert {
...
// SetPermissionID sets the "permission_id" field.
func (u *RolePermissionUpsertOne) SetPermissionID(v int64) *RolePermissionUpsertOne {
	return u.Update(func(s *RolePermissionUpsert) {
		s.SetPermissionID(v)
	})
}
...
// SetPermissionID sets the "permission_id" field.
func (u *RolePermissionUpsertBulk) SetPermissionID(v int64) *RolePermissionUpsertBulk {
	return u.Update(func(s *RolePermissionUpsert) {
		s.SetPermissionID(v)
	})
}
