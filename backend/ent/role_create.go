...
func (_c *RoleCreate) SetAuthzVersion(v int64) *RoleCreate {
	_c.mutation.SetAuthzVersion(v)
	return _c
}

// SetNillableAuthzVersion sets the "authz_version" field if the given value is not nil.
func (_c *RoleCreate) SetNillableAuthzVersion(v *int64) *RoleCreate {
	if v != nil {
...
func (_c *RoleCreate) AddServicePrincipalIDs(ids ...int64) *RoleCreate {
	_c.mutation.AddServicePrincipalIDs(ids...)
	return _c
}

// AddServicePrincipals adds the "service_principals" edges to the ServicePrincipal entity.
func (_c *RoleCreate) AddServicePrincipals(v ...*ServicePrincipal) *RoleCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddServicePrincipalIDs(ids...)
}

// AddUserRoleIDs adds the "user_roles" edge to the UserRole entity by IDs.
func (_c *RoleCreate) AddUserRoleIDs(ids ...int64) *RoleCreate {
...
func (_c *RoleCreate) AddServicePrincipalRoleIDs(ids ...int64) *RoleCreate {
...
func (_c *RoleCreate) AddServicePrincipalRoles(v ...*ServicePrincipalRole) *RoleCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *RoleCreate) check() error {
	...
	if _, ok := _c.mutation.AuthzVersion(); !ok {
		return &ValidationError{Name: "authz_version", err: errors.New(`ent: missing required field "Role.authz_version"`)}
	}
	return nil
}
...
func (_c *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.ServicePrincipalsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
...
// SetAuthzVersion sets the "authz_version" field.
func (u *RoleUpsert) SetAuthzVersion(v int64) *RoleUpsert {
	u.Set(role.FieldAuthzVersion, v)
	return u
}

// UpdateAuthzVersion sets the "authz_version" field to the value that was provided on create.
func (u *RoleUpsert) UpdateAuthzVersion() *RoleUpsert {
	u.SetExcluded(role.FieldAuthzVersion)
	return u
}

// AddAuthzVersion adds v to the "authz_version" field.
func (u *RoleUpsert) AddAuthzVersion(v int64) *RoleUpsert {
	u.Add(role.FieldAuthzVersion, v)
	return u
}
...
// SetAuthzVersion sets the "authz_version" field.
func (u *RoleUpsertOne) SetAuthzVersion(v int64) *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.SetAuthzVersion(v)
	})
}
...
// AddAuthzVersion adds v to the "authz_version" field.
func (u *RoleUpsertOne) AddAuthzVersion(v int64) *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.AddAuthzVersion(v)
	})
}
...
// UpdateAuthzVersion sets the "authz_version" field to the value that was provided on create.
func (u *RoleUpsertOne) UpdateAuthzVersion() *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
...
// SetAuthzVersion sets the "authz_version" field.
func (u *RoleUpsertBulk) SetAuthzVersion(v int64) *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.SetAuthzVersion(v)
	})
}
...
// AddAuthzVersion adds v to the "authz_version" field.
func (u *RoleUpsertBulk) AddAuthzVersion(v int64) *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.AddAuthzVersion(v)
	})
}
...
// UpdateAuthzVersion sets the "authz_version" field to the value that was provided on create.
func (u *RoleUpsertBulk) UpdateAuthzVersion() *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateAuthzVersion()
	})
}
