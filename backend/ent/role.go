...
type RoleEdges struct {
	...
	// ServicePrincipals holds the value of the service_principals edge.
...
// ServicePrincipalsOrErr returns the ServicePrincipals value or an error if the edge
// was not loaded in eager-loading.
func (e RoleEdges) ServicePrincipalsOrErr() ([]*ServicePrincipal, error) {
	if e.loadedTypes[2] {
		return e.ServicePrincipals, nil
	}
	return nil, &NotLoadedError{edge: "service_principals"}
}
...
// was not loaded in eager-loading.
func (e RoleEdges) ServicePrincipalRolesOrErr() ([]*ServicePrincipalRole, error) {
	if e.loadedTypes[5] {
...
func (*Role) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case role.FieldID, role.FieldAuthzVersion:
...
// QueryServicePrincipals queries the "service_principals" edge of the Role entity.
func (_m *Role) QueryServicePrincipals() *ServicePrincipalQuery {
	return NewRoleClient(_m.config).QueryServicePrincipals(_m)
}
...
// QueryServicePrincipalRoles queries the "service_principal_roles" edge of the Role entity.
func (_m *Role) QueryServicePrincipalRoles() *ServicePrincipalRoleQuery {
	return NewRoleClient(_m.config).QueryServicePrincipalRoles(_m)
}
