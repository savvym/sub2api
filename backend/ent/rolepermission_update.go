...
func (_u *RolePermissionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(rolepermission.Table, rolepermission.Columns, sqlgraph.NewFieldSpec(rolepermission.FieldRoleID, field.TypeInt64), sqlgraph.NewFieldSpec(rolepermission.FieldPermissionID, field.TypeInt64))
