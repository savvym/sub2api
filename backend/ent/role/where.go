...
func AuthzVersion(v int64) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldAuthzVersion, v))
}
...
func AuthzVersionEQ(v int64) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldAuthzVersion, v))
}

// AuthzVersionNEQ applies the NEQ predicate on the "authz_version" field.
func AuthzVersionNEQ(v int64) predicate.Role {
	return predicate.Role(sql.FieldNEQ(FieldAuthzVersion, v))
}

// AuthzVersionIn applies the In predicate on the "authz_version" field.
func AuthzVersionIn(vs ...int64) predicate.Role {
	return predicate.Role(sql.FieldIn(FieldAuthzVersion, vs...))
}

// AuthzVersionNotIn applies the NotIn predicate on the "authz_version" field.
func AuthzVersionNotIn(vs ...int64) predicate.Role {
	return predicate.Role(sql.FieldNotIn(FieldAuthzVersion, vs...))
}

// AuthzVersionGT applies the GT predicate on the "authz_version" field.
func AuthzVersionGT(v int64) predicate.Role {
	return predicate.Role(sql.FieldGT(FieldAuthzVersion, v))
}

// AuthzVersionGTE applies the GTE predicate on the "authz_version" field.
func AuthzVersionGTE(v int64) predicate.Role {
	return predicate.Role(sql.FieldGTE(FieldAuthzVersion, v))
}

// AuthzVersionLT applies the LT predicate on the "authz_version" field.
func AuthzVersionLT(v int64) predicate.Role {
	return predicate.Role(sql.FieldLT(FieldAuthzVersion, v))
}

// AuthzVersionLTE applies the LTE predicate on the "authz_version" field.
func AuthzVersionLTE(v int64) predicate.Role {
	return predicate.Role(sql.FieldLTE(FieldAuthzVersion, v))
}
...
// HasServicePrincipals applies the HasEdge predicate on the "service_principals" edge.
func HasServicePrincipals() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasServicePrincipalsWith applies the HasEdge predicate on the "service_principals" edge with a given conditions (other predicates).
func HasServicePrincipalsWith(preds ...predicate.ServicePrincipal) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := newServicePrincipalsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func HasServicePrincipalRoles() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasServicePrincipalRolesWith(preds ...predicate.ServicePrincipalRole) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
